...
export const EQUIPMENT_BALANCE = {
  ...
  slotBaseStats: {
    ...
    armor: {
      knight: { hp: 22, reg: 0.015 },
      mage: { hp: 20, reg: 0.025 },
      assassin: { hp: 14, reg: 0.04 },
    },
  ...
  enhancement: {
    ...
    baseGoldCost: 90,
    costGrowth: 1.38,
    baseStatFlatPerLevel: {
      common: {
        weapon: { atk: 2 },
        helmet: { def: 1 },
        armor: { hp: 6, reg: 1 },
        accessory: { atk: 1, critChance: 1 },
      },
      magic: {
        weapon: { atk: 3 },
        helmet: { def: 2 },
      ...
      rare: {
        ...
        helmet: { def: 3 },
        armor: { hp: 11, reg: 2 },
        accessory: { atk: 2, critChance: 1 },
      },
      epic: {
        weapon: { atk: 5 },
        helmet: { def: 4 },
        armor: { hp: 15, reg: 2 },
        accessory: { atk: 3, critChance: 2 },
      },
      legendary: {
        weapon: { atk: 7 },
        helmet: { def: 5 },
        armor: { hp: 20, reg: 3 },
        accessory: { atk: 4, critChance: 2 },
      },
    },
  ...
  generalAffixTierWeights: {
    // TODO(Equipment): Tune after enough drop/reawakening samples from real play.
    surplus: 100,
    main: 34,
    rare: 10,
    ultraRare: 2,
...
export const AFFIX_BALANCE = {
  ...
  general: {
    attackFlat: { min: 1, max: 6 },
    attackPercent: { min: 2, max: 8 },
    defenseFlat: { min: 1, max: 5 },
    hpFlat: { min: 8, max: 36 },
    hpRegen: { min: 1, max: 4 },
    accuracy: { min: 4, max: 18 },
    evasion: { min: 2, max: 12 },
    moveSpeed: { min: 2, max: 8 },
    strFlat: { min: 1, max: 5 },
    gritFlat: { min: 1, max: 5 },
    agiFlat: { min: 1, max: 5 },
    strPercent: { min: 2, max: 8 },
    gritPercent: { min: 2, max: 8 },
    agiPercent: { min: 2, max: 8 },
    ...
    additionalDamage: { min: 3, max: 16 },
    defPenetration: { min: 4, max: 18 },
    defPenetrationPercent: { min: 3, max: 12 },
    lifeSteal: { min: 1, max: 4, cap: 10 },
    goldGain: { min: 5, max: 20 },
    experienceGain: { min: 3, max: 12 },
